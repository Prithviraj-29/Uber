...
const VehiclePanel = (props) => {
  return (
    <div>
        ...
        <div className='flex items-center justify-between p-3 w-full mb-2 border-2 border-white active:border-black bg-gray-100 rounded-xl'>
          ...
          <h2 className='text-lg font-semibold'>₹74.35</h2>
        </div>
        ...
        <div className='flex items-center justify-between p-3 w-full mb-2 border-2 border-white active:border-black bg-gray-100 rounded-xl'>
          ...
          <h2 className='text-lg font-semibold'>₹114.65</h2>
        </div>
        ...
        <div className='flex items-center justify-between p-3 w-full mb-2 border-2 border-white active:border-black bg-gray-100 rounded-xl'>
          ...
          <h2 className='text-lg font-semibold'>₹185.35</h2>
        </div>
    </div>
  )
}
